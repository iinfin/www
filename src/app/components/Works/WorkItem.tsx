...
export default function WorkItem({ work, baseIndex }: WorkItemProps): ReactElement {
	...
	return (
		<div className="work col-span-6 mb-20 grid grid-cols-6">
			...
			{/* Link (New) */}
			{work.link && (
				<div className="col-span-6 col-start-6 row-start-3 text-right md:col-span-1 md:col-start-6 md:row-start-2 lg:col-span-1 lg:col-start-6 3xl:col-span-1 3xl:col-start-6">
